...
<link rel="stylesheet" type="text/css" href="{{asset('/template/frontend/')}}/styles/cart_styles.css">
<link rel="stylesheet" type="text/css" href="{{asset('/template/frontend/')}}/styles/cart_responsive.css">

@extends('frontend.master')
@section('content')
	@include('frontend.element.cart.cart')
@endsection
...
<script src="{{asset('/template/frontend/')}}/js/cart_custom.js"></script>